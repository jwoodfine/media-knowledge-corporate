# Content contract — content-wiki-corporate
...
> wiki server that renders this repo at `corporate.woodfinegroup.com`.
>
...
references:
  - id: 1
    ...
    path: "company/example"           # optional — used with internal: true
```
...
- **BCSC disclosure rule** (workspace §6) — Sovereign Data
  ...
  served at `corporate.woodfinegroup.com`.
